...
{
	return {
		"name":			"Cordova AdMobInMobi",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaAdmobInMobi",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.2",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"admob-inmobi mediation",
...
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-ad-admob-inmobi",		
