...
cr.plugins_.cranberrygame_CordovaAdmobInMobi = function(runtime)
{
...
(function ()
{
	...
	// *** CHANGE THE PLUGIN ID HERE *** - must match the "id" property in edittime.js
	//                            vvvvvvvv
	var pluginProto = cr.plugins_.cranberrygame_CordovaAdmobInMobi.prototype;
...
/*
		...
		window.addEventListener("resize", function () {//cranberrygame
			self.runtime.trigger(cr.plugins_.cranberrygame_CordovaAdmobInMobi.prototype.cnds.TriggerCondition, self);
		});
*/
//cranberrygame start
