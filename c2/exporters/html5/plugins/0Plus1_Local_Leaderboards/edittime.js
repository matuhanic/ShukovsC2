...
AddExpression(1, ef_return_string, "Position string", "Data", "currentPosition", "Get the current position of the score inside the leaderboard loop.");

AddExpression(2, ef_return_string, "Name string", "Data", "currentName", "Get the current name in the leaderboard loop.");
////////////////////////////////////////
