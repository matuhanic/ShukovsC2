...
{
	return {
		"name":			"Cordova Media",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaMedia",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.7",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"supports c2's Audio plugin. (c2 Audio plugin seems to use Media plugin on android, wp8)",
...
phonegap build service: https://build.phonegap.com/plugins/1168
cordova registry: http://plugins.cordova.io/#/package/org.apache.cordova.media
github: https://github.com/apache/cordova-plugin-media/releases/tag/r0.2.16
//cranberrygame end
*/
		//"cordova-plugins":	"org.apache.cordova.media@0.2.13",
		//"cordova-plugins":	"org.apache.cordova.media@0.2.15",		//x
		//"cordova-plugins":	"org.apache.cordova.media@0.2.16",	//x	
		//"cordova-plugins":	"org.apache.cordova.file@1.3.1;org.apache.cordova.media@0.2.16",	//x	
		//"cordova-plugins":	"cordova-plugin-media",
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-media-minimum",
