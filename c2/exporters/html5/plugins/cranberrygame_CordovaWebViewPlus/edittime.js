...
{
	return {
		"name":			"Cordova WebViewPlus",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaWebViewPlus",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.7",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"support ludei Webview+ for android 4.x",
		"author":		"cranberrygame",
		"help url":		"http://cranberrygame.github.io?referrer=edittime.js",
		"category":		"Cordova extension: performance",				// Prefer to re-use existing categories, but you can set anything here
...
cordova registry: http://plugins.cordova.io/#/package/com.ludei.webview.plus
github: https://github.com/ludei/webview-plus/tree/2.4.2
//cranberrygame end
*/
		//"cordova-plugins":	"com.ludei.webview.plus@2.4.2",		
		"cordova-plugins":	"webview-plus@2.2.0",		
