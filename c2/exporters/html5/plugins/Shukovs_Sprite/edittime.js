﻿function GetPluginSettings()
{
	return {
		...
		"id":			"ShukovsSprite",
		"version":		"1.1",
		"description":	"A customizable animated sprite for game development projects with mesh deformation.",
		"author":		"Matvey Shukov",
		"help url":		"https://shukovs-games.com/docs/sprite",
		"category":		"Graphics",
		"type":			"world",
		"rotatable":	true,
...
AddNumberParam("Columns", "Number of mesh columns (segments).");
AddNumberParam("Rows", "Number of mesh rows (segments).");
AddAction(13, 0, "Set mesh grid", "Mesh", "Set mesh grid to {0} x {1}", "Set the size of the mesh grid.", "SetMeshGrid");

AddNumberParam("Index", "The user-defined index for the deformation point.");
AddNumberParam("X", "The world X coordinate to find the closest grid intersection.");
AddNumberParam("Y", "The world Y coordinate to find the closest grid intersection.");
AddAction(14, 0, "Create deformation point", "Mesh", "Create deformation point with index {0} at closest to ({1}, {2})", "Create a deformation point at the closest grid intersection.", "CreateDeformPoint");

AddNumberParam("Index", "The user-defined index for the deformation point.");
AddNumberParam("X", "The new world X position for the point.");
AddNumberParam("Y", "The new world Y position for the point.");
AddAction(15, 0, "Move deformation point", "Mesh", "Move deformation point {0} to ({1}, {2})", "Move a deformation point to a new position.", "MoveDeformPoint");

AddNumberParam("Index", "The user-defined index for the deformation point.");
AddAction(16, 0, "Delete deformation point", "Mesh", "Delete deformation point {0}", "Delete a deformation point by index.", "DeleteDeformPoint");

AddAction(17, 0, "Delete all deformation points", "Mesh", "Delete all deformation points", "Delete all deformation points.", "DeleteAllDeformPoints");

AddAction(18, 0, "Reset deformation points", "Mesh", "Reset all deformation points to standard positions", "Reset the position of all points to standard.", "ResetDeformPoints");

AddNumberParam("Index", "The user-defined index for the deformation point.");
AddNumberParam("Weight", "The weight for the deformation point, affecting influence strength and radius.");
AddAction(19, 0, "Set deformation point weight", "Mesh", "Set deformation point {0} weight to {1}", "Set the weight of a deformation point.", "SetDeformPointWeight");
...
AddNumberParam("Index", "The user-defined index for the deformation point.");
AddExpression(9, ef_return_number, "Deformation point X", "Mesh", "DeformPointX", "Get the world X position of a deformation point by index.");

AddNumberParam("Index", "The user-defined index for the deformation point.");
AddExpression(10, ef_return_number, "Deformation point Y", "Mesh", "DeformPointY", "Get the world Y position of a deformation point by index.");

AddExpression(11, ef_return_number, "Deformation points count", "Mesh", "DeformPointCount", "Get the number of deformation points.");

AddNumberParam("Index", "The user-defined index for the deformation point.");
AddExpression(12, ef_return_number, "Deformation point weight", "Mesh", "DeformPointWeight", "Get the weight of a deformation point by index.");
...
var property_list = [
	...
	new cr.Property(ept_integer, "Mesh columns", 1, "Number of mesh columns (segments)."),
	new cr.Property(ept_integer, "Mesh rows", 1, "Number of mesh rows (segments).")
	];
