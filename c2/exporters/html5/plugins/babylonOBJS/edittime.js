function GetPluginSettings() {
	return {
		"name": "OBJ-JS Mesh", // as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id": "babylonOBJ", // this is used to identify this plugin and is saved to the project; never change it
		"version": "1.0", // (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description": "Loads an OBJ or JS mesh to the scene",
		"author": "X3M",
...
var property_list = [
		new cr.Property(ept_text, "Name", "Batman", "A name to be assigned to this object, it just serves for identification purposes, the engine won't use it."),
	...
	new cr.Property(ept_section, "Mesh properties", "", ""),
		new cr.Property(ept_text, "Filename", "bat_man", "The filename without the extension"),
		new cr.Property(ept_combo, 	"Type",		"Obj",		"The file type.","Obj|Js"),
		new cr.Property(ept_text, "XYZ Rotation", "0,0,0", "The mesh rotation in degrees."),
		new cr.Property(ept_float, "Z size", 20, "The mesh depth."),
		new cr.Property(ept_float, "Z position", 0, "The mesh z position."),
		new cr.Property(ept_text, "XYZ offset", "0,0,0", "The mesh offset from the parent."),
		new cr.Property(ept_text, "XYZ scaling", "1,1,1", "The mesh scaling."),
		new cr.Property(ept_combo, 	"Debug",		"False",		"Shows the parent mesh.","False|True")
];
