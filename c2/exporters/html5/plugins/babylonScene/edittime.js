...
{
	return {
		"name":			"Scene",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"babylonSceneSLE",	// this is used to identify this plugin and is saved to the project; never change it
		...
		,"dependency": "babylon.custom.js;oimo.js;cannon.js;babylon.objFileLoader.js;hand.js"
	};
};
...
var property_list = [
		new cr.Property(ept_text,	"Filename",	"scene.babylon",	"The filename of the scene, you should rename it to .js before exporting to web since the .babylon extension is not allowed by most of the websites."),
...
IDEInstance.prototype.Draw = function(renderer)
{
	...
	if (this.font != null)
	{
		...
		renderer.Quad(q, 1);
		this.font.DrawText(this.properties["Filename"],
								q,
								cr.RGB(0,0,0),
								ha_center,
								1,
