...
(function ()
{
	...
	{		
		...
		//socket received an event! -will be executed for any event received-
		(function() {
    ...
    //Warning this exression actually manupalates the data stack, be careful when evaluating it in Construct
