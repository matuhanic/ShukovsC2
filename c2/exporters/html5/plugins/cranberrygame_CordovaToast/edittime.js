...
{
	return {
		"name":			"Cordova Toast",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaToast",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.4",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"show a native toast (a little text popup).",
...
phonegap build service: https://build.phonegap.com/plugins/740
cordova registry: 
github: https://github.com/EddyVerbruggen/Toast-PhoneGap-Plugin/tree/720f87abc865ad836e097101dbfc2af7bdf8fca7
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/EddyVerbruggen/Toast-PhoneGap-Plugin#720f87abc865ad836e097101dbfc2af7bdf8fca7",		
...
*/
//cranberrygame start
AddStringParam("Message", "Enter a message.", "\"Toast message\"");
AddComboParamOption("short (2 seconds)");
AddComboParamOption("long (5 seconds)");
AddComboParam("Duration", "Select duration");
AddComboParamOption("top");
AddComboParamOption("center");
AddComboParamOption("bottom");
AddComboParam("Position", "Select position", 2);
AddAction(0, af_none, "Show toast", "My category", "Show toast {0} for {1} at the {2}", "Description for my action!", "ShowToast");
//cranberrygame end
