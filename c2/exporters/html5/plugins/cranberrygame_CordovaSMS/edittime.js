...
{
	return {
		"name":			"Cordova SMS",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaSMS",				// this is used to identify this plugin and is saved to the project; never change it
...
cordova registry: 
github: https://github.com/aharris88/phonegap-sms-plugin/tree/caec82e1bc490780b53d2d588604e80add9ea737
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/aharris88/phonegap-sms-plugin#caec82e1bc490780b53d2d588604e80add9ea737",		
...
*/
//cranberrygame start
AddStringParam("Phone Number", "Enter phone number. ex) \"12345678\", \"12345678,12345679\"", "\"12345678\"");
AddStringParam("Message", "Enter message.");
AddAction(0, af_none, "SendSMS", "My category", "SendSMS {0} {1}", "show SMS send Form", "SendSMS");
//cranberrygame end
