...
{
	return {
		"name":			"Cordova WallPaper",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaWallPaper",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.1",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"set wall paper image.",
...
/*
//cranberrygame start
ca.purplemad.wallpaper
phonegap build service: https://build.phonegap.com/plugins/392
cordova registry: 
github: https://github.com/PurpleMADcanada/Wallpaper-PhoneGap-Plugin/tree/e8838e1a91b47093b00e669b8a5efadd3f7ddbd8
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/PurpleMADcanada/Wallpaper-PhoneGap-Plugin#e8838e1a91b47093b00e669b8a5efadd3f7ddbd8",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On set wall paper image succeeded", "My category", "On set wall paper image succeeded", "Description for my condition!", "OnSetWallPaperImageSucceeded");
AddCondition(1, cf_trigger, "On set wall paper image failed", "My category", "On set wall paper image failed", "Description for my condition!", "OnSetWallPaperImageFailed");
...
*/
//cranberrygame start
//AddStringParam("Image file", "Enter image file's relative path to index.html or remote url. ex1) \"wallpaper1.png\", \"wallpaper/wallpaper1.png\" ex2) \"https://static4.scirra.net/images/fresh/scirra-logo-01.png\"", "\"www/loading-logo.png\"");
AddStringParam("Image file", "Enter image file's relative path to index.html. ex) \"wallpaper1.png\", \"wallpaper/wallpaper1.png\"", "\"wallpaper1.png\"");
AddAction(0, af_none, "Set wall paper image", "My category", "Set wall paper image {0}", "Description for my action!", "SetWallPaperImage");
//cranberrygame end
