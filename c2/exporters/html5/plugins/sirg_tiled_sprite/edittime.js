function GetPluginSettings()
{
	return {
		...
		"author":		"SirG",
		"help url":		"http://www.scirra.com/forum/plugin-tiled-sprite_topic53015.html",
...
AddCondition(7, cf_trigger, "On image URL loaded", "Web", "On image URL loaded", "Triggered after 'Load image from URL' when the image has finished loading.", "OnURLLoaded");
...
var property_list = [
	...
	//new cr.Property(ept_float,	"Hotspot X",			0,	"Hotspot X position."),
	//new cr.Property(ept_float,	"Hotspot Y",			0,	"Hotspot X position.")
	];
...
function IDEInstance(instance, type)
{
	...
	this.custom_hotspot_x = 0;
	this.custom_hotspot_y = 0;
}
...
IDEInstance.prototype.OnCreate = function()
{
	if (this.properties["Hotspot"] === "Top-left"){
		...
		//this.custom_hotspot_x = 0;
		//this.custom_hotspot_y = 0;
		//this.properties["Hotspot X"] = 0;
		//this.properties["Hotspot Y"] = 0;
	}else{
		this.instance.SetHotspot(new cr.vector2(0.5, 0.5));
		//this.custom_hotspot_x = 0.5;
		//this.custom_hotspot_y = 0.5;
		//this.properties["Hotspot X"] = 0.5;
		//this.properties["Hotspot Y"] = 0.5;
	}
}
...
IDEInstance.prototype.OnRendererInit = function(renderer)
{
	...
	this.instance.SetHotspot(new cr.vector2(this.custom_hotspot_x, this.custom_hotspot_y));
}
