...
{
	return {
		"name":			"Cordova NavigationBar",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaNavigationBar",				// this is used to identify this plugin and is saved to the project; never change it
...
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-navigationbar",		
...
*/
//cranberrygame start
AddAction(0, af_none, "Hide navigation bar", "My category", "Hide navigation bar", "Description for my action!", "HideNavigationBar");
//cranberrygame end
...
*/
//cranberrygame start
	new cr.Property(ept_combo,	"Auto hide navigation bar",					"Yes",		"Hide navigation bar automatically.", "No|Yes")
//cranberrygame emd
	];
