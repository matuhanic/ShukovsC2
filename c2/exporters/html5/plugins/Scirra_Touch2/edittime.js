...
AddCondition(7, cf_trigger, "On touch move", "Touch", "On touch move", "Triggered when a touch moves.", "OnTouchMove");
...
AddNumberParam("Index", "Touch index");
AddExpression(13, ef_return_number | ef_variadic_parameters, "Touch X position", "Touch", "TouchX", "Get the touch X co-ordinate in the layout.");
AddNumberParam("Index", "Touch index");
AddExpression(14, ef_return_number | ef_variadic_parameters, "Touch Y position", "Touch", "TouchY", "Get the touch Y co-ordinate in the layout.");
AddExpression(15, ef_return_number, "Number of touches", "Touch", "TouchCount", "How many touches there is");
