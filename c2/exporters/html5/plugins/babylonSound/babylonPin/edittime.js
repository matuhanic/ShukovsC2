function GetBehaviorSettings()
{
	return {
		...
		"id":			"babylonPin",					// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",
		"description":	"Stick to another mesh maintaining a relative distance and angle.",
		"author":		"X3M",
		"help url":		"",
		"category":		"Babylon Mesh",				// Prefer to re-use existing categories, but you can set anything here
