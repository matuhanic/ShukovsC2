...
{
	return {
		"name":			"Cordova ScreenOrientation",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaScreenOrientation",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.8",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"auto lock screen orientation, lock and unlock screen orientation.",
...
cordova registry: 
github: https://github.com/gbenvenuti/cordova-plugin-screen-orientation/tree/v1.4.0
//cranberrygame end
*/
		"cordova-plugins":	"cordova-plugin-screen-orientation@1.4.1",		
...
AddComboParam("Screen orientation", "Select screen orientation.", 0);
AddAction(0, af_none, "Lock screen orientation", "My category", "Lock screen orientation {0}", "Description for my action!", "LockScreenOrientation");
AddAction(1, af_none, "Unlock screen orientation", "My category", "Unlock screen orientation", "Description for my action!", "UnlockScreenOrientation");
//cranberrygame end
...
*/
//cranberrygame start
	new cr.Property(ept_combo, "Auto lock screen orientation", "Portrait", "Lock screen orientation automatically.", "Off|Portrait|Landscape|Unlock")
//cranberrygame emd
	];
