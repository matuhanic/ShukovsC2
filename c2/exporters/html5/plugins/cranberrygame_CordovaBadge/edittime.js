...
{
	return {
		"name":			"Cordova Badge",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaBadge",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.4",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"access and modify the badge number of the app icon.",
...
phonegap build service: https://build.phonegap.com/plugins/1123
cordova registry: http://plugins.cordova.io/#/package/de.appplant.cordova.plugin.badge
github: https://github.com/katzer/cordova-plugin-badge/tree/653ea60
//cranberrygame end
*/		
		"cordova-plugins":	"de.appplant.cordova.plugin.badge@0.5.3", 		
...
*/
//cranberrygame start
AddNumberParam("Badge", "Enter number.");
AddAction(0, af_none, "Set badge", "My category", "Set badge {0}", "Description for my action!", "SetBadge");
AddAction(1, af_none, "Clear badge", "My category", "Clear badge", "Description for my action!", "ClearBadge");
//cranberrygame end
...
*/
//cranberrygame start
AddExpression(0, ef_return_number, "Return badge number.", "My category", "Badge", "Return badge number.");
//cranberrygame end
