...
// Create plugin class
cr.plugins_.Clock = function(runtime)
{
...
cr.plugins_.Clock.prototype.Type = function(plugin)
{
	assert2(this instanceof arguments.callee, "Constructor called as a function");
	assert2(plugin instanceof cr.plugins_.Clock, "Creating type with wrong plugin");
	
	this.plugin = plugin;
	this.runtime = plugin.runtime;
};

cr.plugins_.Clock.prototype.Type.prototype.onCreate = function()
{
};

// Class representing an object instance
cr.plugins_.Clock.prototype.Instance = function(type)
{
	assert2(this instanceof arguments.callee, "Constructor called as a function");
...
cr.plugins_.Clock.prototype.Instance.prototype.onCreate = function()
{
	
};

cr.plugins_.Clock.prototype.Instance.prototype.draw = function(ctx)
{
};

//////////////////////////////////////
// Conditions
cr.plugins_.Clock.prototype.cnds = {};

(function()
{
	// Get prototype for the conditions object that stores condition methods for an instance
	var cnds = cr.plugins_.Clock.prototype.cnds;
	
}());

//////////////////////////////////////
// Actions
cr.plugins_.Clock.prototype.acts = {};

(function()
{
	// Get prototype for the actions object that stores action methods for an instance
	var acts = cr.plugins_.Clock.prototype.acts;
