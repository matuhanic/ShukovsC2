...
{
	return {
		"name":			"Cordova DeviceOrientation",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaDeviceOrientation",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.3",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"detects the heading that the device is pointed. (compass)",
...
phonegap build service: https://build.phonegap.com/plugins/1179
cordova registry: http://plugins.cordova.io/#/package/org.apache.cordova.device-orientation
github: https://github.com/apache/cordova-plugin-device-orientation/tree/a09ef3c
//cranberrygame end
*/
		"cordova-plugins":	"cordova-plugin-device-orientation",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On get heading succeeded", "My category", "On get heading succeeded", "Description for my condition!", "OnGetHeadingSucceeded");//cranberrygame
AddCondition(1, cf_trigger, "On get heading failed", "My category", "On get heading failed", "Description for my condition!", "OnGetHeadingFailed");//cranberrygame
AddCondition(2, cf_trigger, "On watch heading succeeded", "My category", "On watch heading succeeded", "Description for my condition!", "OnWatchHeadingSucceeded");//cranberrygame
AddCondition(3, cf_trigger, "On watch heading failed", "My category", "On watch heading failed", "Description for my condition!", "OnWatchHeadingFailed");//cranberrygame
//cranberrygame end
...
*/
//cranberrygame start
AddAction(0, af_none, "Get heading", "My category", "Get heading", "Description for my action!", "GetHeading");
AddAction(1, af_none, "Watch heading", "My category", "Watch heading", "Description for my action!", "WatchHeading");
AddAction(2, af_none, "Clear watch", "My category", "Clear watch", "Description for my action!", "ClearWatch");
//cranberrygame end
...
*/
//cranberrygame start
AddExpression(0, ef_return_number, "Get heading", "My category", "Heading", "The heading in degrees from 0-359.99 at a single moment in time. (Number)"); //cranberrygame
//cranberrygame end
