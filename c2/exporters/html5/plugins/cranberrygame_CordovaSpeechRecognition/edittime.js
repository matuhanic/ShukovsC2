...
{
	return {
		"name":			"Cordova SpeechRecognition",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaSpeechRecognition",				// this is used to identify this plugin and is saved to the project; never change it
...
/*
//cranberrygame start
com.manueldeveloper.speech-recognizer
phonegap build service: 
cordova registry: http://plugins.cordova.io/#/package/com.manueldeveloper.speech-recognizer
github: https://github.com/manueldeveloper/cordova-plugin-speech-recognizer#3a78b72c3f3063bda2389e5c866fb26097a9d07c
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/manueldeveloper/cordova-plugin-speech-recognizer#3a78b72c3f3063bda2389e5c866fb26097a9d07c",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On speech recognition succeeded", "My category", "On speech recognition succeeded", "Description for my condition!", "OnSpeechRecognitionSucceeded");//cranberrygame
AddCondition(1, cf_trigger, "On speech recognition failed", "My category", "On speech recognition failed", "Description for my condition!", "OnSpeechRecognitionFailed");//cranberrygame
AddCondition(2, cf_looping, "For each element", "For Each", "For each element", "Repeat the event for each element.", "ArrForEach");
//cranberrygame end
...
*/
//cranberrygame start
AddAction(0, af_none, "Recognize speech", "My category", "Recognize speech", "Trigger TriggerCondition", "RecognizeSpeech");//cranberrygame
//cranberrygame end
...
/*
// example
AddExpression(0, ef_return_number, "Get cell x count", "My category", "GetCellXCount", "Get cell x count."); //cranberrygame
...
*/
//cranberrygame start
AddExpression(0, ef_return_any, "Current Value", "For Each", "CurValue", "Get the current value in a For Each loop.");
//cranberrygame end
