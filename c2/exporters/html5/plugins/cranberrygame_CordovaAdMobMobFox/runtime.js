...
cr.plugins_.cranberrygame_CordovaAdmobMobFox = function(runtime)
{
...
(function ()
{
	...
	// *** CHANGE THE PLUGIN ID HERE *** - must match the "id" property in edittime.js
	//                            vvvvvvvv
	var pluginProto = cr.plugins_.cranberrygame_CordovaAdmobMobFox.prototype;
...
/*
		...
		window.addEventListener("resize", function () {//cranberrygame
			self.runtime.trigger(cr.plugins_.cranberrygame_CordovaAdmobMobFox.prototype.cnds.TriggerCondition, self);
		});
*/
//cranberrygame start
