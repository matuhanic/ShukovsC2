...
{
	return {
		"name":			"Material",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"babylonMaterialSLE",	// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Represents a material of a mesh located in the scene",
		"author":		"X3M",
...
var property_list = [
		new cr.Property(ept_text,	"Name",	"Mat001",	"The material name as in the 3D editor"),
		new cr.Property(ept_integer,	"Scene ID",	"0",	"The scene ID in which this material belongs")
	];
...
IDEInstance.prototype.Draw = function(renderer)
{
	...
	if (this.font != null)
	{
		...
		this.font.DrawText(this.properties["Name"],
								...
								0,
								ha_center);
		renderer.Outline(q, cr.RGB(250,60,65));
		renderer.Outline(scale(q,1), cr.RGB(250,60,65));
