...
{
	return {
		"name":			"Cordova SoftKeyboard",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaSoftKeyboard",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.4",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"show and hide soft keyboard.",
...
/*
//cranberrygame start
de.phonostar.softkeyboard-custom
phonegap build service: https://build.phonegap.com/plugins/726
cordova registry: 
github: https://github.com/pgraham/PhoneGap-SoftKeyboard/tree/deab7c9b4c20298c3a86b71a336655e3ccd15ade
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/pgraham/PhoneGap-SoftKeyboard#deab7c9b4c20298c3a86b71a336655e3ccd15ade",		
...
*/
//cranberrygame start
AddAction(0, af_none, "Show", "My category", "Show", "Description for my action!", "Show");
AddAction(1, af_none, "Hide", "My category", "Hide", "Description for my action!", "Hide");
//cranberrygame end
