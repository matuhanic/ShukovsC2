...
{
	return {
		"name":			"Cordova PhoneCallStatus",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaPhoneCallStatus",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.1",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"check phone call status. (ringing, off hook, idle)",
...
cordova registry: 
github: https://github.com/renanoliveira/cordova-phone-call-trap/tree/e49abb943552725820238912fc259c81871f25c5
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/renanoliveira/cordova-phone-call-trap#e49abb943552725820238912fc259c81871f25c5",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On phone call status ringing", "My category", "On phone call status ringing", "Description for my condition!", "OnPhoneCallStatusRinging");//cranberrygame
AddCondition(1, cf_trigger, "On phone call status off hook", "My category", "On phone call status off hook", "Description for my condition!", "OnPhoneCallStatusOffHook");//cranberrygame
AddCondition(2, cf_trigger, "On phone call status idle", "My category", "On phone call status idle", "Description for my condition!", "OnPhoneCallStatusIdle");//cranberrygame
//cranberrygame end
...
*/
//cranberrygame start
AddAction(0, af_none, "Phone call status", "My category", "Phone call status", "Description for my action!", "PhoneCallStatus");
//cranberrygame end
