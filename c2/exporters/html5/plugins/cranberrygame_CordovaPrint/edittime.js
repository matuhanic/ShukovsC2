...
{
	return {
		"name":			"Cordova Print",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaPrint",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.4",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"use Google Cloud Print for android and AirPrint for iOS.",
...
phonegap build service: https://build.phonegap.com/plugins/388
cordova registry: 
github: https://github.com/hazemhagrass/phonegap-print/tree/d4337811eec5667cba85058e7e86d7a1f80d4bbe
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/hazemhagrass/phonegap-print#d4337811eec5667cba85058e7e86d7a1f80d4bbe",		
...
AddStringParam("Contents", "Enter contents.");
AddComboParamOption("text/plain");
AddComboParamOption("text/html");
AddComboParam("type", "Select type");
AddAction(0, af_none, "Print", "My category", "Print {0} {1}", "Description for my action!", "Print");
//cranberrygame end
