...
{
	return {
		"name":			"Referrer",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_Referrer",				// this is used to identify this plugin and is saved to the project; never change it
...
/*
//cranberrygame start
cordova-plugin-analytics-referrer
cordova-plugin-preference
phonegap build service: 
cordova registry: 
github:
https://github.com/cranberrygame/cordova-plugin-analytics-referrer
https://github.com/cranberrygame/cordova-plugin-preference
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-analytics-referrer;https://github.com/cranberrygame/cordova-plugin-preference",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On check referrer succeeded", "My category", "On check referrer succeeded", "Description for my condition!", "OnCheckReferrerSucceeded");//cranberrygame
AddCondition(1, cf_trigger, "On check referrer failed", "My category", "On check referrer failed", "Description for my condition!", "OnCheckReferrerFailed");//cranberrygame
//cranberrygame end
...
*/
//cranberrygame start
AddAction(0, af_none, "Check referrer", "My category", "Check referrer", "Description for my action!", "CheckReferrer");
//cranberrygame end
...
*/
//cranberrygame start
AddExpression(0, ef_return_string, "Get referrer.", "My category", "Referrer", "Get referrer. ex) facebokad (http://mydomain.com/avoidshit/index.html?referrer=facebookad) (https://play.google.com/store/apps/details?id=com.cranberrygame.avoidshit&referrer=facebookad) (market://details?id=com.cranberrygame.avoidshit&referrer=facebookad)"); //cranberrygame
AddStringParam("StringParam", "Enter string param ex1) \"utm_campaign\" ex2) \"utm_source\" ex3) \"utm_medium\" ex4) \"utm_term\" ex5) \"utm_content\" ex6) \"gclid\"");
AddExpression(1, ef_return_string, "Get referrer sub parameter.", "My category", "ReferrerSubParameter", "Get referrer sub parameter."); //cranberrygame
//cranberrygame end
