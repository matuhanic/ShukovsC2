...
{
	return {
		"name":			"Cordova VolumeSlider",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaVolumeSlider",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.4",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"add a native volume slider (MPVolumeView) to your app.",
...
/*
//cranberrygame start
org.devgeeks.volumeslider
phonegap build service: https://build.phonegap.com/plugins/782
cordova registry: http://plugins.cordova.io/#/package/org.devgeeks.volumeslider
github: https://github.com/devgeeks/VolumeSlider/tree/120a9d04d3336776fb58703dcb0c2b1b77550489
//cranberrygame end
*/
		"cordova-plugins":	"org.devgeeks.volumeslider@1.0.0",		
...
*/
//cranberrygame start
AddAction(0, af_none, "Show volume slider", "My category", "Show volume slider", "Description for my action!", "ShowVolumeSlider");
AddAction(1, af_none, "Hide volume slider", "My category", "Hide volume slider", "Description for my action!", "HideVolumeSlider");
//cranberrygame end
