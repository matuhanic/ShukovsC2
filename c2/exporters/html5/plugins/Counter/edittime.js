...
function GetPluginSettings()
{
	return {
		...
		"id":			"Counter",
		"version":		"1.0",
		"description":	"Used to store numbers and to display them either as an animation, a simple number or as vertical or horizontal bars.",
		"author":		"stas's ports",
		"help url":		"http://www.scirra.com/manual/166/sprite-font",
		"category":		"Clickteam Extensions",
		"type":			"world",			// appears in layout
		"rotatable":	false,				// can be rotated in layout
...
var property_list = [
	...
	new cr.Property(ept_integer,"Character width",		11,			"Width of each cell in the image."),
	new cr.Property(ept_integer,"Character height",		18,			"Height of each cell in the image."),
	new cr.Property(ept_text,	"Character set",		"", "List of characters in the spritefont image, starting in the top-left."),
