...
cr.plugins_.cranberrygame_CordovaShortcut = function(runtime)
{
...
(function ()
{
	...
	// *** CHANGE THE PLUGIN ID HERE *** - must match the "id" property in edittime.js
	//                            vvvvvvvv
	var pluginProto = cr.plugins_.cranberrygame_CordovaShortcut.prototype;
...
/*
		...
		window.addEventListener("resize", function () {//cranberrygame
			self.runtime.trigger(cr.plugins_.cranberrygame_CordovaShortcut.prototype.cnds.TriggerCondition, self);
		});
*/
//cranberrygame start
