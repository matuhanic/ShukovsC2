...
{
	return {
		"name":			"Cordova Shortcut",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaShortcut",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.3",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"create shortcut in the home screen.",
...
phonegap build service: https://build.phonegap.com/plugins/265
cordova registry: 
github: https://github.com/jorgecis/ShortcutPlugin/tree/4c2c01cc2473f4d3af8bfb6809f5d647c0078d72
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/jorgecis/ShortcutPlugin#4c2c01cc2473f4d3af8bfb6809f5d647c0078d72",		
...
AddAction(0, af_none, "Create shortcut", "My category", "Create shortcut {0}", "Description for my action!", "CreateShortcut");
AddStringParam("Message", "Enter message.");
AddAction(1, af_deprecated, "Remove shortcut", "My category", "Remove shortcut {0}", "Description for my action!", "RemoveShortcut");
//cranberrygame end
