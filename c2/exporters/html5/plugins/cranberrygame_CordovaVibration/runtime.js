...
cr.plugins_.cranberrygame_CordovaVibration = function(runtime)
{
...
(function ()
{
	...
	// *** CHANGE THE PLUGIN ID HERE *** - must match the "id" property in edittime.js
	//                            vvvvvvvv
	var pluginProto = cr.plugins_.cranberrygame_CordovaVibration.prototype;
...
/*
		...
		window.addEventListener("resize", function () {//cranberrygame
			self.runtime.trigger(cr.plugins_.cranberrygame_CordovaVibration.prototype.cnds.TriggerCondition, self);
		});
*/
//cranberrygame start
