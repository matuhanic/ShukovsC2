...
{
	return {
		"name":			"Cordova GoogleAnalytics",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaGoogleAnalytics",				// this is used to identify this plugin and is saved to the project; never change it
...
cordova registry: http://plugins.cordova.io/#/package/com.danielcwilson.plugins.googleanalytics
github: https://github.com/danwilson/google-analytics-plugin/tree/c13ad4bb9d165b0036f2a6f7f10aeeda48f9f72b
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/danwilson/google-analytics-plugin#c13ad4bb9d165b0036f2a6f7f10aeeda48f9f72b",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On track screen succeeded", "My category", "On track screen succeeded", "Description for my condition!", "OnTrackScreenSucceeded");//cranberrygame
AddCondition(1, cf_trigger, "On track screen failed", "My category", "On track screen failed", "Description for my condition!", "OnTrackScreenFailed");//cranberrygame
AddCondition(2, cf_trigger, "On track event succeeded", "My category", "On track event succeeded", "Description for my condition!", "OnTrackEventSucceeded");//cranberrygame
AddCondition(3, cf_trigger, "On track event failed", "My category", "On track event failed", "Description for my condition!", "OnTrackEventFailed");//cranberrygame
//cranberrygame end
...
*/
//cranberrygame start
AddStringParam("Screen name", "Enter screen name. ex) \"Layout 1\"", "\"Layout 1\"");
AddAction(0, af_none, "Track screen", "My category", "Track screen {0}", "Description for my action!", "TrackScreen");
AddStringParam("Event category", "Enter event category. ex) \"IAP\"", "\"IAP\"");
AddStringParam("Event action", "Enter event action. ex) \"Purchase product removeads\"", "\"Purchase product removeads\"");
//AddStringParam("Event label", "Enter event label. ex) \"My label\"", "\"My label\"");
//AddNumberParam("Event value", "Enter event value. ex) 1", "1");
AddAction(1, af_none, "Track event", "My category", "Track event {0} {1}", "Description for my action!", "TrackEvent");
//cranberrygame end
...
*/
//cranberrygame start
	//new cr.Property(ept_text, 	"Track id",		"",		"An example property.") //cranberrygame , this.properties[0] from runtime.js
	new cr.Property(ept_text, 	"Android track id",		"",		"An example property."), //cranberrygame , this.properties[0] from runtime.js
	new cr.Property(ept_text, 	"iOS track id",		"",		"An example property.") //cranberrygame , this.properties[0] from runtime.js
//cranberrygame emd
	];
