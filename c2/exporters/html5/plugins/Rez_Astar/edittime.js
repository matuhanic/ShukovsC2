...
AddAction(3, af_none, "Set cost using object", "Pathfinding", "{2} cost using {0} with {1}", "Set cost using an object (this unblocks cells).", "SetCostUsingObject");
...
////////////////////////////////////////
// Expressions
AddNumberParam("X", "Grid X position.", "0");
AddNumberParam("Y", "Grid Y position.", "0");
AddExpression(0, ef_return_number, "GetBlockAt", "Pathfinding", "GetBlockAt", "This returns 1 if the position is blocked or 0 if open.");

AddNumberParam("X", "Grid X position.", "0");
AddNumberParam("Y", "Grid Y position.", "0");
AddExpression(1, ef_return_number, "GetCostAt", "Pathfinding", "GetCostAt", "This returns the current cell extra cost.");
