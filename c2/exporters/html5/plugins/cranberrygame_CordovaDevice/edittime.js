...
{
	return {
		"name":			"Cordova Device",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaDevice",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.3",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"get device info (cordova version, device's model name, device's OS name, device's UUID, device's OS version).",
...
phonegap build service: https://build.phonegap.com/plugins/1178
cordova registry: http://plugins.cordova.io/#/package/org.apache.cordova.device
github: https://github.com/apache/cordova-plugin-device/tree/c6e23d8
//cranberrygame end
*/
...
*/
//cranberrygame start
AddExpression(0, ef_return_string, "Get the version of Cordova.", "My category", "Cordova", "Get the version of Cordova. ex) 3.6.3"); //cranberrygame
AddExpression(1, ef_return_string, "Get the name of the device's model or product", "My category", "Model", "Get the name of the device's model or product. ex) Nexus S"); //cranberrygame
AddExpression(2, ef_return_string, "Get the device's operating system name.", "My category", "Platform", "Get the device's operating system name. ex) Android"); //cranberrygame
AddExpression(3, ef_return_string, "Get the device's Universally Unique Identifier (UUID).", "My category", "UUID", "Get the device's Universally Unique Identifier (UUID). ex) 92b9548b3817ce0e"); //cranberrygame
AddExpression(4, ef_return_string, "Get the operating system version.", "My category", "Version", "Get the operating system version. ex) 4.1.1"); //cranberrygame
//cranberrygame end
