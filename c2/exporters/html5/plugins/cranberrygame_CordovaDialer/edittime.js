...
{
	return {
		"name":			"Cordova Dialer",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaDialer",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.3",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"dial a phone number directly without user ineraction.",
...
phonegap build service: https://build.phonegap.com/plugins/328
cordova registry: 
github: https://github.com/anemitoff/PhoneGap-PhoneDialer/tree/0aef448287b8778d435d933037d90445ddb10133
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/anemitoff/PhoneGap-PhoneDialer#0aef448287b8778d435d933037d90445ddb10133",		
...
*/
//cranberrygame start
AddStringParam("Phone number", "Enter phone number.");
AddAction(0, af_none, "Dial", "My category", "Dial {0}", "Description for my action!", "Dial");
//cranberrygame end
