...
{
	return {
		"name":			"Cordova CustomURLScheme",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaCustomURLScheme",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.1",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"support custom URL scheme (for example testapp://) for other app to launch this app.",
...
cordova registry: 
github: https://github.com/EddyVerbruggen/Custom-URL-scheme/tree/0a28acf59807b273da074ff15b75355983da3bb3
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/EddyVerbruggen/Custom-URL-scheme#0a28acf59807b273da074ff15b75355983da3bb3 --variable URL_SCHEME='YOUR_APP_URL_SCHEME'",		
