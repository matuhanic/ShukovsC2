...
(function ()
{
	...
	Acts.prototype.loadCreature2djson = function (jsonText)
	{
		...
		var new_animation_1 = new CreatureAnimation(actual_JSON, "default", creature);
		
		this.creature_manager = new CreatureManager(creature);
		this.creature_manager.AddAnimation(new_animation_1);
		this.creature_manager.SetActiveAnimationName("default", false);
