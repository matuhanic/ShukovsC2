...
{
	return {
		"name":			"Q3D\nPoint",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"Q3Dpoint",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"2.4",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Creates a fast simple empty object that can be used to represent a position or point, does not support collisions",
		"author":		"Quazi",
