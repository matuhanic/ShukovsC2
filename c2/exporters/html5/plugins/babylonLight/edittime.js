...
{
	return {
		"name":			"Light",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"babylonLightSLE",	// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Represents a light located in the scene",
		"author":		"X3M",
...
var property_list = [
		new cr.Property(ept_text,	"Name",	"Omni001",	"The light name as in the 3D editor"),
		new cr.Property(ept_integer,	"Scene ID",	"0",	"The scene ID in which this light belongs"),
		...
		new cr.Property(ept_combo, 	"Axis",		"ZY",		"The axis will only affect the C2 default behaviors positioning and rotation on which they work.","ZY|XY")
	];
