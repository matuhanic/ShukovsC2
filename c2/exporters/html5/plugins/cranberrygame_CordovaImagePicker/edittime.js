...
{
	return {
		"name":			"Cordova ImagePicker",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaImagePicker",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.2",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"pick image from photo gallery.",
...
https://build.phonegap.com/plugins/807
http://plugins.cordova.io/#/package/com.synconset.imagepicker
https://github.com/wymsee/cordova-imagePicker#v1.0.6
//cranberrygame end
*/
		"cordova-plugins":	"com.synconset.imagepicker@1.0.6",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On pick image succeeded", "My category", "On pick image succeeded", "Description for my condition!", "OnPickImageSucceeded");
AddCondition(1, cf_trigger, "On pick image failed", "My category", "On pick image failed", "Description for my condition!", "OnPickImageFailed");
//cranberrygame end
...
*/
//cranberrygame start
AddAction(0, af_none, "Pick image", "My category", "Pick image", "Description for my action!", "PickImage");
//cranberrygame end
...
*/
//cranberrygame start
AddExpression(0, ef_return_number, "Get picked images count", "My category", "PickedImagesCount", "Get picked images count."); //cranberrygame
AddNumberParam("Index", "Enter index");
AddExpression(1, ef_return_string, "Get picked image's file uri at.", "My category", "PickedImageAt", "Get picked image's file uri at. ex) file:///data/data/com.cranberrygame.projectname/cache/60183-286546205.jpg");
//cranberrygame end
