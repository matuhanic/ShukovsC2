...
{
	return {
		"name":			"Cordova ScreenOrientationLandscape",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaScreenOrientationLandscape",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.3",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"auto lock screen orientation landscape. (fix xdk not locking ios orientation issue, for example: not restore landscape after taking camera picture)",
...
cordova registry: 
github: https://github.com/cranberrygame/cordova-plugin-screenorientation-landscape
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-screenorientation-landscape",		
