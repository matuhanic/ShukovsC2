function GetPluginSettings()
{
	return {
		...
		"id":			"KeyboardPlus",
		"version":		"1.0",
		"description":	"Retrieve input from the keyboard. Enhanced version of Scirra´s Keyboard plugin.",
		"author":		"GameSoul",
		"help url":		"http://www.scirra.com/manual/113/keyboard",
		"category":		"GameSoul - Input",
...
AddCondition(8, 0, "Any key is down", "Keyboard", "Any key is down", "Test if any keyboard key is currently held down.", "IsAnyKeyDown");
...
AddComboParamOption("Left shift");
AddComboParamOption("Right shift");
AddComboParamOption("Left control");
AddComboParamOption("Right control");
AddComboParamOption("Left alt");
AddComboParamOption("Right alt");
AddComboParamOption("Left meta");
AddComboParamOption("Right meta");
AddComboParam("Key", "Choose a key."); // <b>{0} ({1})</b> is down
AddCondition(9,	cf_none, "Left/right key is down", "Left/right keys", "<b>{0}</b> is down", "Test if a specific left or right keyboard key is currently held down, e.g. left shift.", "LeftRightIsKeyDown");
...
AddComboParamOption("Left meta");
AddComboParamOption("Right meta");
AddComboParam("Key", "Choose a key."); // On <b>{0} ({1})</b> pressed
AddCondition(10, cf_trigger, "On left/right key pressed", "Left/right keys", "On <b>{0}</b> pressed", "Triggered when a specific left or right keyboard key is pressed, e.g. left shift.", "OnLeftRightKey");
...
AddComboParamOption("Left meta");
AddComboParamOption("Right meta");
AddComboParam("Key", "Choose a key."); // On <b>{0} ({1})</b> released
AddCondition(11, cf_trigger, "On left/right key released", "Left/right keys", "On <b>{0}</b> released", "Triggered when a specific left or right keyboard key is released, e.g. left shift.", "OnLeftRightKeyReleased");
//////////////////////////////////////////////////////////////
// Expressions
...
AddExpression(2, ef_return_string, "", "Key codes", "TypedKey", "Get the typed key string for the last pressed key.");
