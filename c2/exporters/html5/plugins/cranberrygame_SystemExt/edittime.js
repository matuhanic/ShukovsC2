...
{
	return {
		"name":			"SystemExt",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"SystemExt",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.1",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"support useful functionalities in addition to an official System plugin's.",
...
*/
//cranberrygame start
AddComboParamOption("node-webkit Windows");
AddComboParamOption("node-webkit Linux");
AddComboParamOption("node-webkit Mac OS X");
AddComboParamOption("Pokki app");
AddComboParam("Platform", "The platform to check.1");
AddCondition(0, cf_none, "Is on platform", "Special conditions", "Is on platform {0}", "The platform to check.2", "IsOnPlatform");
//cranberrygame end
