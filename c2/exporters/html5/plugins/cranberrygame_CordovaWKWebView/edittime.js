...
{
	return {
		"name":			"Cordova WKWebView",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaWKWebView",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.5",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"support apple WKWebView for ios8.",
...
cordova registry: 
github: https://github.com/Telerik-Verified-Plugins/WKWebView/tree/0.3.4
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/Telerik-Verified-Plugins/WKWebView#0.3.4",		
