...
cr.plugins_.cranberrygame_CordovaWKWebView = function(runtime)
{
...
(function ()
{
	...
	// *** CHANGE THE PLUGIN ID HERE *** - must match the "id" property in edittime.js
	//                            vvvvvvvv
	var pluginProto = cr.plugins_.cranberrygame_CordovaWKWebView.prototype;
...
/*
		...
		window.addEventListener("resize", function () {//cranberrygame
			self.runtime.trigger(cr.plugins_.cranberrygame_CordovaWKWebView.prototype.cnds.TriggerCondition, self);
		});
*/
//cranberrygame start
