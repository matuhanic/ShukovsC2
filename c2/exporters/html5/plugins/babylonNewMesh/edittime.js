function GetPluginSettings() {
	return {
		"name": "New Mesh", // as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id": "babylonNewMesh", // this is used to identify this plugin and is saved to the project; never change it
		"version": "1.0", // (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description": "Adds a new mesh to the scene",
		"author": "X3M",
...
var property_list = [
	new cr.Property(ept_text, "Name", "Box001", "A name to be assigned to this object, it just serves for identification purposes, the engine won't use it."),
	...
	new cr.Property(ept_section, "New mesh properties", "", ""),
	new cr.Property(ept_combo, "Type", "Box", "The shape type.", "Box|Sphere|Plane|Cylinder|Torus|Ground"),
	new cr.Property(ept_text, "XY Rotation", "0,0", "The mesh rotation in degrees."),
	new cr.Property(ept_float, "Z size", 20, "The mesh depth."),
	new cr.Property(ept_float, "Z position", 0, "The mesh z position."),
	new cr.Property(ept_float, "[Sphere/Ground] Segments", 10, "The number of segments."),
	new cr.Property(ept_float, "[Cylinder] Top diameter", 3, "The diameter of the top."),
	new cr.Property(ept_float, "[Cylinder] Bottom diameter", 3, "The diameter of the bottom."),
	new cr.Property(ept_float, "[Cylinder/Torus] Tessellation", 6, "The tessellation of the faces."),
	new cr.Property(ept_float, "[Torus] Tickness", 1, "The thickness of the donut."),
	new cr.Property(ept_section, "Material properties", "", ""),
	new cr.Property(ept_integer, "Texture Frame", 0, "Which texture frame to use."),
	new cr.Property(ept_float, "uScale", 1, "Repeat n times on the Vertical Axes."),
	new cr.Property(ept_float, "vScale", 1, "Repeat n times on the Horizontal Axes."),
	new cr.Property(ept_float, "uOffset", 0.0, "Translate uv horizantaly."),
	new cr.Property(ept_float, "vOffset", 0.0, "Translate uv verticaly."),
	new cr.Property(ept_combo, "HasAlpha", "False", "Does the texture has an alpha channel.", "False|True"),
	new cr.Property(ept_combo, "BackFaceCulling", "False", "Always show the front and the back of an element or not.", "False|True"),
	new cr.Property(ept_float, "Specular power", 32, "The specular power."),
	new cr.Property(ept_float, "Roughness", 3.0, "The roughness of the reflection."),
	new cr.Property(ept_float, "[Heightmap] Min elevation", 1.0, "The minimum elevation of the height texture."),
	new cr.Property(ept_float, "[Heightmap] Max elevation", 10.0, "The maximum elevation of the height texture.")
];
...
IDEInstance.prototype.Draw = function (renderer) {
	...
	if (this.font != null) {
		...
		renderer.Outline(scale(q,1), cr.RGB(0,0,0));
