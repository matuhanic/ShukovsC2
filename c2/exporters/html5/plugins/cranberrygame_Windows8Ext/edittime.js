...
{
	return {
		"name":			"Windows8Ext",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"Windows8Ext",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.2",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"support useful functionalities in addition to an official Windows8 plugin's.",
...
*/
//cranberrygame start
	new cr.Property(ept_combo,	"'About' setting",	"No",	"Show an 'About' option in the Settings charm, which opens about.html.", "No|Yes"),
	...
	new cr.Property(ept_combo,	"'Support' setting", "No",	"Show a 'Support' option in the Settings charm, which opens support.html.", "No|Yes"),
