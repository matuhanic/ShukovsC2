...
{
	return {
		"name":			"Cordova StatusBar",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaStatusBar",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.3",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"auto hide, hide and show status bar.",
...
phonegap build service: https://build.phonegap.com/plugins/715 (0.1.4)
cordova registry: http://plugins.cordova.io/#/package/org.apache.cordova.statusbar (no 0.1.4)
github: https://github.com/apache/cordova-plugin-statusbar/tree/bdbaf129595c4a4e3d957a1bc218d05dc5f82a9e
//cranberrygame end
*/
		"cordova-plugins":	"cordova-plugin-statusbar",		
...
*/
//cranberrygame start
AddAction(0, af_none, "Hide status bar", "My category", "Hide status bar", "Description for my action!", "HideStatusBar");
AddAction(1, af_none, "Show status bar", "My category", "Show status bar", "Description for my action!", "ShowStatusBar");
//cranberrygame end
...
*/
//cranberrygame start
	new cr.Property(ept_combo, "Auto hide status bar", "Yes", "Hide status bar automatically.", "No|Yes"),
//cranberrygame emd
	];
