...
{
	return {
		"name":			"Mesh",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"babylonMeshSLE",	// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Represents a mesh located in the scene",
		"author":		"X3M",
...
var property_list = [
		new cr.Property(ept_text,	"Name",	"Box001",	"The mesh name as in the 3D editor"),
		new cr.Property(ept_integer,	"Scene UID",	"0",	"The scene UID in which this mesh belongs"),
