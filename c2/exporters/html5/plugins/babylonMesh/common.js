...
//			 display_str,		// as appears in event sheet - use <b>{0}</b> , {1} for parameters and also <b></b>, <i></i>
//			 description,		// appears in event wizard dialog when selected
//			 script_name);		// corresponding runtime function name

// example
//AddStringParam("Message", "Enter a string to alert.");
//AddAction(0, af_none, "Alert", "My category", "Alert <b>{0}</b> ", "Description for my action!", "MyAction");
////////////////////////////////////////
// Expressions
...
AddObjectParam("Parent mesh", "The parent mesh");
...
AddCondition(id, cf_fake_trigger | cf_static, "On collision with another object", "Collisions", "On collision with {0}", "Triggered when the object collides with another object.", "OnCollision");
id++;
AddObjectParam("Object", "Select the object to test for overlap with.");
AddCondition(id, 0, "Is overlapping another object", "Collisions", "Is overlapping {0}", "Test if the object is overlapping another object.", "IsOverlapping");
id++
AddObjectParam("Object", "Select the object to test for overlap with.");
...
AddCondition(id, 0, "Is overlapping at offset", "Collisions", "Is overlapping {0} at offset (<i>{1}</i>, <i>{2}</i>)", "Test if the object is overlapping another object at an offset position.", "IsOverlappingOffset");
...
AddAction(id, cf_none, "Apply displacement", "Babylon Rendering", "Apply displacement map <b>{0}</b> to  mesh with min height of <b>{1}</b> and max height of  <b>{2}</b>", "Apply displacement map to mesh", "MeshDisplMap");
id++;

AddObjectParam("Mesh", "The mesh wich has the bone");
AddStringParam("Bone name", "The bone name", initial_string = "\"Head\"");
AddAction(id, cf_none, "Attach to bone", "Babylon Bones", "Attach mesh to bone <b>{1}</b> of mesh {0}", "Attach mesh to bone", "MeshAttachToBone");
id++;

AddAction(id, cf_none, "Set flatshaded", "Babylon Rendering", "Set mesh flatshaded", "Set mesh flatshaded", "MeshSetFlatShaded");
id++;

AddAction(id, cf_none, "Detach from bone", "Babylon Bones", "Detach mesh from its bone", "Detach mesh from bone", "MeshDetachFromBone");
id++;
...
AddAction(id, cf_none, "Set edge color", "Babylon Rendering", "Set mesh edges color to <b>{0},{1},{2}</b>", "Set mesh edges color", "MeshEdgeColor");
id++;

AddNumberParam("Edge width", "Edge width value.", initial_string = "0.3");
AddAction(id, cf_none, "Set edge width", "Babylon Rendering", "Set mesh edges width to <b>{0}</b>", "Set mesh edges width", "MeshEdgeWidth");
id++;
...
AddAction(id, cf_none, "Set collision ellipsoid", "Babylon Collisions", "Set mesh ellipsoid to <b>{0},{1},{2}</b>", "Set mesh collision ellipsoid", "MeshEllipsoid");
id++;
...
AddAction(id, af_none, "Morph vertices", "Babylon Matrix", "Morph this mesh from vertex <b>({0})</b> to <b>({1})</b>, morph by <b>({2},{3},{4})</b>.", "Morph mesh by translating vertices", "MeshMorphVertices");
id++;
...
AddAction(id, af_none, "Set texture frame", "Babylon Material", "Set this mesh material texture frame to <b>({0})</b>.", "Set mesh texture frame", "MeshSetTextuFrame");
id++;
...
AddStringParam("Filename", "The refraction box texture prefix", initial_string = "\"skybox\"");
AddAction(id, af_none, "Set refraction texture", "Babylon Material", "Set material refraction texture box to <b>({0})</b>.", "Set the material refraction texture.", "MatSetRefraTexture");
id++;
