function GetPluginSettings()
{
	return {
		...
		"id":			"cranberrygame_CordovaPowerManagement",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.6",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"full wake lock for the app which runs for a long time without user interaction.",
...
cordova registry: 
github: https://github.com/cranberrygame/cordova-plugin-powermanagement
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-powermanagement",		
...
*/
//cranberrygame start
AddAction(0, af_none, "Acquire", "My category", "Acquire", "Description for my action!", "Acquire");
AddAction(1, af_none, "Release", "My category", "Release", "Description for my action!", "Release");
AddAction(2, af_deprecated, "Dim", "My category", "Dim", "Description for my action!", "Dim");
AddAction(3, af_deprecated, "Partial", "My category", "Partial", "Description for my action!", "Partial");
//cranberrygame end
