...
populateCommonACE = function () {
	...
	id++;
	AddNumberParam("Skeleton ID", "", initial_string = "0");
	AddNumberParam("From", "", initial_string = "0");
	AddNumberParam("To", "", initial_string = "20");
	AddComboParamOption('Disabled');
	AddComboParamOption('Enabled');
	AddComboParam('Loop', 'Set state', 'Disabled');
	AddNumberParam("Speed", "", initial_string = "20");
	AddAction(id, af_none, "Play skeleton animation", "Babylon Animations", "Play animation of skeleton <b>({0})</b> from <b>({1})</b> to <b>({2})</b> set loop to <b>({3})</b>.", "Play animation", "PlaySkelAnim");
	id++;
	AddAction(id, af_none, "Stop skeleton animation", "Babylon Animations", "Stop animation of skeleton <b>({0})</b>.", "Stop animation", "StopSkelAnim");
	id++;
