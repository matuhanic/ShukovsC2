...
{
	return {
		"name":			"Cordova Vungle",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"cranberrygame_CordovaVungle",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.29",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"show vungle rewarded video ad.",
...
cordova registry: http://plugins.cordova.io/#/package/com.cranberrygame.cordova.plugin.ad.vungle
github: https://github.com/cranberrygame/cordova-plugin-ad-vungle
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-ad-vungle",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger | cf_deprecated, "On available", "Rewarded video ad", "On available", "Description for my condition!", "OnAvailable");
AddCondition(1, cf_trigger | cf_deprecated, "On unavailable", "Rewarded video ad", "On unavailable", "Description for my condition!", "OnUnavailable");
...
AddCondition(5, cf_trigger | cf_deprecated, "On rewarded video ad not completed", "Rewarded video ad", "On rewarded video ad not completed", "Triggered when TriggerAction", "OnRewardedVideoAdNotCompleted");//cranberrygame
//
...
*/
//cranberrygame start
AddAction(0, af_none | af_deprecated, "Check available", "Rewarded video ad", "Check available", "Description for my action!", "CheckAvailable");
...
//cranberrygame start
	...
	new cr.Property(ept_text, 	"iOS app id",		"",		"An example property.") //cranberrygame , this.properties[2] from runtime.js
/*	
