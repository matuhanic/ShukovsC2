function GetPluginSettings() {
	return {
		"name": "3D Sprite", // as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id": "babylon3DSprite", // this is used to identify this plugin and is saved to the project; never change it
		"version": "1.0", // (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description": "Adds a 3D sprite to the scene",
		"author": "X3M",
...
var property_list = [
		new cr.Property(ept_text, "Name", "Sprite", "A name to be assigned to this object, it just serves for identification purposes, the engine won't use it."),
	...
	new cr.Property(ept_section, "Mesh properties", "", ""),
		new cr.Property(ept_text, "Animation", "Default", "The animation name"),
		new cr.Property(ept_integer, "Frame", 0, "The frame number of the animation"),
		new cr.Property(ept_combo, 	"Autoplay",		"False",		"Autoplay the animation","False|True"),
		new cr.Property(ept_float, "Cell width", 32, "The sprite sheet cell width."),
		new cr.Property(ept_float, "Cell height", 64, "The sprite sheet cell height."),
		new cr.Property(ept_integer, "Init frame", 0, "The starting frame."),
		new cr.Property(ept_integer, "Ending frame", 10, "The ending frame.")
];
...
IDEInstance.prototype.Draw = function (renderer) {
	...
	if (this.font != null) {
		...
		this.font.DrawText(this.properties["Name"],
			...
			0,
			va_top);
		renderer.Outline(q, cr.RGB(0,0,255));
