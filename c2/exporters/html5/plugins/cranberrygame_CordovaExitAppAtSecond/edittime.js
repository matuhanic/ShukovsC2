...
{
	return {
		"name":			"Cordova ExitAppAtSecond",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"CordovaExitAppAtSecond",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0.23",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"exit app at second on android and wp8.",
...
/*
//cranberrygame start
cordova-plugin-exitappatsecond
phonegap build service: 
cordova registry: 
github: https://github.com/cranberrygame/cordova-plugin-exitappatsecond
//cranberrygame end
*/
		"cordova-plugins":	"https://github.com/cranberrygame/cordova-plugin-exitappatsecond",		
...
*/
//cranberrygame start
AddCondition(0, cf_trigger, "On exit app at second", "My category", "On exit app at second", "Triggered when TriggerAction", "OnExitAppAtSecond");//cranberrygame
//cranberrygame end
...
*/
//cranberrygame start
AddAction(0, af_none, "Exit app at second", "My category", "Exit app at second", "Description for my action!", "ExitAppAtSecond");
//cranberrygame end
