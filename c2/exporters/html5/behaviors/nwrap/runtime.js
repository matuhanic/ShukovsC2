...
/////////////////////////////////////
// Behavior class
cr.behaviors.nwrap = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.nwrap.prototype;
	...
	behinstProto.tick = function ()
	{
		...
		if (this.enabled) {this.isenabled = 1} else {this.isenabled = 0}
		...
		if (this.enabled)
		{
			...
			if (bbox.right < lbound)
			{
				...
				this.runtime.trigger(cr.behaviors.nwrap.prototype.cnds.OnWrap, this.inst); // test
			}
