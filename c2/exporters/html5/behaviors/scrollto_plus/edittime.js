function GetBehaviorSettings()
{
	return {
		...
		"id":			"ScrollToPlus",
		"version":		"1.0",
		"description":	"Always center the view on this object, or at the mid-point of multiple objects. Enhanced version of Scirra's ScrollTo behavior.",
		"author":		"GameSoul",
...
AddComboParam("Shake in corners", ".");
AddAction(0, 0, "Shake", "", "Shake {my} with magnitude <i>{0}</i> for <i>{1}</i> seconds ({2}, shake in corners: {3})", "Shake the screen for a duration of time.", "Shake");
