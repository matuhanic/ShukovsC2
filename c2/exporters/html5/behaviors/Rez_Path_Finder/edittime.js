...
AddAction(1, af_none, "Associate pathfinder", "Pathfinding", "Associate pathfinder with {0}", "Associate pathfinder with an Astar plugin object.", "Setup");
AddAction(2, af_none, "Clear path", "Pathfinding", "Clear path", "Clear current path.", "ClearPath");
AddAction(3, af_none, "Reset position", "Pathfinding", "Reset <b>path</b> position", "Reset internal position counter.", "ResetPosition");
AddAction(4, af_none, "Next position", "Pathfinding", "Next <b>path</b> position", "Add one to the internal position counter.", "NextPosition");
...
AddExpression(3, ef_return_number, "InPathX", "Pathfinding", "InPathX", "This returns an X position based on the internal position counter.");
AddExpression(4, ef_return_number, "InPathY", "Pathfinding", "InPathY", "This returns an Y position based on the internal position counter.");
