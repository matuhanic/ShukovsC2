function GetBehaviorSettings()
{
	return {
		...
		"id":			"PlatformPluss",
		"version":		"1.0",
		"description":	"Jump and run along platforms (solid/jump-thru objects). Enhanced version of Scirra's Platform behavior.",
		"author":		"GameSoul",
...
/* AddCmpParam("Comparison", "Choose the way to compare the gravity.");
AddNumberParam("Gravity", "The gravity to compare to.");
AddCondition(6, 0, "Compare gravity", "", "{my} gravity {0} {1}", "Compare the gravity of the object.", "CompareGravity"); */
...
AddCondition(7, cf_trigger, "On jump", "Animation triggers", "{my} On jump", "Triggered when jumping.", "OnJump");
AddCondition(8, cf_trigger, "On fall", "Animation triggers", "{my} On fall", "Triggered when falling.", "OnFall");
AddCondition(9, cf_trigger, "On stopped", "Animation triggers", "{my} On stopped", "Triggered when stopped moving.", "OnStop");
AddCondition(10, cf_trigger, "On moved", "Animation triggers", "{my} On moved", "Triggered when starting to move.", "OnMove");
AddCondition(11, cf_trigger, "On landed", "Animation triggers", "{my} On landed", "Triggered when first hitting the floor.", "OnLand");

AddComboParamOption("left");
AddComboParamOption("right");
AddComboParamOption("top");
AddComboParam("Side", "Select the side to test for a wall.");
AddCondition(13, 0, "Is by wall", "", "{my} has wall to {0}", "Test if the object has a wall to the left, right or top.", "IsByWall");

AddCondition(14, 0, "Is double-jump enabled", "", "{my} double-jump is enabled", "True if double-jump is currently enabled.", "IsDoubleJumpEnabled");
AddCondition(15, 0, "Is enabled", "", "{my} is enabled", "Test if the behavior is enabled.", "IsBehaviorEnabled");
//////////////////////////////////////////////////////////////
// Actions
...
AddComboParamOption("Allowed");
AddComboParam("Double jump state", "Whether a double jump is allowed during the current jump.");
AddAction(15, 0, "Reset double jump", "", "Reset {my} double jump allowed <b>{0}</b>", "Change whether a double jump is allowed during a jump.", "ResetDoubleJump");

AddComboParamOption("Stop");
AddComboParamOption("Preserve momentum");
AddComboParam("Mode", "Set how to handle collisions with the ceiling.");
AddAction(16, 0, "Set ceiling collision", "", "Set {my} ceiling collision mode to <b>{0}</b>", "Set how ceiling collisions are handled (stop or preserve momentum).", "SetCeilingCollision");

AddComboParamOption("Disabled");
AddComboParamOption("Enabled");
AddComboParam("Default controls", "Whether to enable or disable the behavior default controls.");
AddAction(17, 0, "Set default controls", "", "Set {my} default controls <b>{0}</b>", "Change the default controls setting.", "SetDefaultControls");
//////////////////////////////////////////////////////////////
// Expressions
...
AddExpression(11, ef_return_number, "Get jump sustain", "", "JumpSustain", "The jump sustain property, in milliseconds.");
AddExpression(12, ef_return_number, "Enabled", "", "Enabled", "The current initial state of behavior.");
