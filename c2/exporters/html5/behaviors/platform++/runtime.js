...
/////////////////////////////////////
// Behavior class
cr.behaviors.PlatformPluss = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.PlatformPluss.prototype;
	...
	behaviorProto.Instance = function(type, inst)
	{
		...
		this.loadFloorObject = -1; // loadFloorUID
		this.lastFloorX = 0;
		this.lastFloorY = 0;
	...
	behinstProto.onCreate = function()
	{
		...
		this.loadOverJumpthru = -1; // loadJumpthruUID
		this.ceilingCollisionMode = 0;
	...
	behinstProto.posttick = function ()
	{
		...
		{			
			...
			if (!this.runtime.testOverlapSolid(this.inst))
			{
				...
				// Trigger On Jump
				this.runtime.trigger(cr.behaviors.PlatformPluss.prototype.cnds.OnJump, this.inst);
		...
		{
			this.runtime.trigger(cr.behaviors.PlatformPluss.prototype.cnds.OnFall, this.inst);
		...
		if ((floor_ || landed) && this.dy >= 0)
		{
			...
			{
				this.runtime.trigger(cr.behaviors.PlatformPluss.prototype.cnds.OnLand, this.inst);
			...
			else
			{
				...
				{
					this.runtime.trigger(cr.behaviors.PlatformPluss.prototype.cnds.OnStop, this.inst);
					this.animMode = ANIMMODE_STOPPED;
				}
				...
				{
					this.runtime.trigger(cr.behaviors.PlatformPluss.prototype.cnds.OnMove, this.inst);
					this.animMode = ANIMMODE_MOVING;
				}
			}
		}
	...
	/* Cnds.prototype.CompareGravity = function (cmp, s)
	{
		return cr.do_cmp(this.g1, cmp, s);
	}; */
	...
	Acts.prototype.SetDefaultControls = function (defc)
	{
		this.defaultControls = (defc === 1);
	};
	...
	Acts.prototype.ResetDoubleJump = function(a)
	{
		this.doubleJumped = !a;
	};
	
	Acts.prototype.SetCeilingCollision = function (ccos)
	{
		this.ceilingCollisionMode = ccos;
	};
