function GetBehaviorSettings()
{
	return {
		...
		"id":			"EightDirPlus",
		"version":		"1.0",
		"description":	"Moves an object up, down, left, right and on diagonals. Enhanced version of Scirra's 8Direction behavior.",
		"author":		"GameSoul",
...
AddCondition(2, 0, "Is enabled", "", "{my} is enabled", "Test if the behavior is enabled.", "IsBehaviorEnabled");
//////////////////////////////////////////////////////////////
// Actions
...
AddAction(11, 0, "Set default controls", "", "Set {my} default controls <b>{0}</b>", "Change the default controls setting.", "SetDefaultControls");
...
AddComboParam("Directions", "The number of directions of movement available to set.");
AddAction(12, 0, "Set directions", "", "Set {my} directions to <b>{0}</b>", "Change the directions setting.", "SetDirections");
//////////////////////////////////////////////////////////////
// Expressions
...
AddExpression(7, ef_return_number, "Enabled", "", "Enabled", "The current initial state of behavior.");
