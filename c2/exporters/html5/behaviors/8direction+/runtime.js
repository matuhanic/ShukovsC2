...
/////////////////////////////////////
// Behavior class
cr.behaviors.EightDirPlus = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.EightDirPlus.prototype;
	...
	behinstProto.getDebuggerValues = function (propsections)
	{
		propsections.push({
			...
			"properties": [
				...
				{"name": "Speed", "value": Math.sqrt(this.dx * this.dx + this.dy * this.dy)},
	...
	Acts.prototype.SetDirections = function (dir)
	{
		switch (dir) {
		case 0:	this.directions = 0; 	break;
		case 1:	this.directions = 1;	break;
		case 2:	this.directions = 2;	break;
		case 3: this.directions = 3;	break;
		}
	};
